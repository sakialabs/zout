@echo off
REM Run contact quality property tests
echo.
echo ================================================
echo Running Contact Quality Property Tests
echo ================================================
echo.

set GODOT_PATH="C:\Program Files\Godot\Godot_v4.3-stable_win64.exe"
set PROJECT_PATH=%~dp0..
set TEST_SCENE=res://tests/scenes/test_contact_quality_consistency.tscn
